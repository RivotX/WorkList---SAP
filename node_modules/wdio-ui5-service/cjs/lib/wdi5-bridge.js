            ...
            switch (_b.label) {
                case 0:
                    ...
                    switch (_a) {
                        ...
                        case "BasicAuth": return [3 /*break*/, 5];
                        case "Office365": return [3 /*break*/, 7];
                ...
                case 4:
                    _b.sent();
                    return [3 /*break*/, 12];
                case 5: return [4 /*yield*/, new BasicAuthenticator_js_1.default(options, browserInstanceName, _config.baseUrl).login()];
                case 6:
                    _b.sent();
                    return [3 /*break*/, 12];
                case 7: return [4 /*yield*/, new Office365Authenticator_js_1.default(options, browserInstanceName).login()];
                case 8:
                    _b.sent();
                    return [3 /*break*/, 12];
                case 9: return [4 /*yield*/, new CustomAuthenticator_js_1.default(options, browserInstanceName).login()];
                case 10:
                    _b.sent();
                    _b.label = 11;
